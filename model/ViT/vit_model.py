...
class VisionTransformer_double_branch(nn.Module):
    ...
    def forward(self, x_1, x_2):
        ...
        x_1 = self.forward_features(x_1)  # [B, 768]
        x_2 = self.forward_features(x_2)  # [B, 768]
        if self.head_dist is not None:
...
def vit_base_patch16_224_in21k(img_size=224, num_classes: int = 21843, in_c=3, has_logits: bool = True, drop_ratio=0.0):
    """
