...
def main(args):
    ...
    train_dataset = MyDataSet(data_file_path=os.path.join(data_path),
                              csv_file_path=os.path.join(csv_path, "split_by_sample_mpa_elec",
                                                         "train", "data_model_train.csv"),
                              num_data=2,
                              transform=data_transform["train"])
    test_dataset = MyDataSet(data_file_path=os.path.join(data_path),
                             csv_file_path=os.path.join(csv_path, "split_by_sample_mpa_elec",
                                                        "test", "data_model_test.csv"),
                             num_data=2,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str,
                        default=os.path.abspath(os.path.join(os.getcwd(), "../..", "result",
                                                             "model_trained", "ViT_concat_by_channel")))
